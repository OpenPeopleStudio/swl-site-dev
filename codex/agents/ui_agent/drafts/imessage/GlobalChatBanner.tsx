...
export function GlobalChatBanner({
  title = "Global Chat",
  description = "Pinned for everyone · iMessage-style",
  onOpen,
  ...
  return (
    <motion.button
      ...
      onClick={onOpen}
      className="group flex w-full items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-left text-white shadow-[inset_0_1px_12px_rgba(255,255,255,0.15)] backdrop-blur"
    >
      <div>
